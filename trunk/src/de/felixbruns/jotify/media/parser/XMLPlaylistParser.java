					...
					if(name.equals("i")){
						...
						if(object instanceof Playlist){
							...
							while(tokenizer.hasMoreTokens()){
								String strstr = tokenizer.nextToken();
								if (Hex.isHex(strstr.substring(0, 32))){
									
									tracks.add(new Track(strstr.substring(0, 32)));
								}
							...
							while(tokenizer.hasMoreTokens()){
								String strstr = tokenizer.nextToken().substring(0, 32);
								if (Hex.isHex(strstr))playlists.add(new Playlist(strstr));
